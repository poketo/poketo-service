...
describe('MangaHereAdapter', () => {
  ...
  describe('getSeries', () => {
    it('returns a metadata object', async () => {
      ...
      expect(metadata).toEqual({
        ...
        url: 'http://www.mangahere.cc/manga/urami_koi_koi_urami_koi',
  ...
  describe('getChapter', () => {
    it('returns a list of pages', async () => {
      ...
      expect(chapter.id).toEqual('492660277');
      expect(chapter.url).toEqual('http://www.mangahere.cc/manga/urami_koi_koi_urami_koi/c038/');
